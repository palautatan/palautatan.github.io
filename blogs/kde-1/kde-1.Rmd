...
The choice of $K$ to estimate a density is proven to be not as crucial as the choice of $h$.
...
Plotted side by side are the original histogram and the kernel density estimator. The estimator looks pretty darn good! Pretty amazing! This KDE is way better than its histogram estimator, and there's no kidding this would converge a lot faster to the truth than a histogram.
